...
?>
<div <?php if ($ajouter_un_id_pour_le_css) :
    ...
    <div class="content_width col_flexible col_flexible_2">
        ...
        <div class="col_flexible_wrapper col_flexible_superposition <?php echo $proportions_des_colonnes; ?>">
            ...
            <div class="col-droite">
                ...
                ?>
				<?= showSvg(get_stylesheet_directory_uri() . '/svg/logo-naviso-expert-logiciel.svg') ?>
                <h3 class="col_flexible_item"><?= $titre_de_la_colonne ?></h3>
                <p class="col_flexible_item"><?= $texte_de_la_colonne ?></p>
    ...
    <?php if ($cb_calltoaction_interne_externe == 'fichier_telechargement') : ?>
        ...
        <?php endif; ?>
    <?php endif; ?>
    <div class="svg-container vague-milieu vague-expert-logiciel">
