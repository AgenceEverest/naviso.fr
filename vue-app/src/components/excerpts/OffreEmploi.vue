...
<template>
  <div>
    ...
    <div class="buttons-extrait">
      ...
      <p v-if="afficherBoutonFicheDePoste &&
          cpt.acf.lien_vers_la_fiche_de_poste !== ''
          " class="cta_btn_lead cta_primaire">
        <a target="_blank" v-if="cpt.acf.hasOwnProperty('lien_vers_la_fiche_de_poste')"
          :href="cpt.acf.lien_vers_la_fiche_de_poste">{{ texteBoutonFicheDePoste }}</a>
      </p>
    </div>
  </div>
</template>
